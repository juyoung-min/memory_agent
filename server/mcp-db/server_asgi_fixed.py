#!/usr/bin/env python3
"""DB-MCP Server with ASGI-fixed SSE support"""
...
def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description="DB-MCP Server with ASGI Fix")
    parser.add_argument("--host", default="0.0.0.0", help="Host to bind to")
    parser.add_argument("--port", type=int, default=8092, help="Port to listen on")
    ...
    logger.info(f"Starting DB-MCP Server (ASGI Fixed) on {args.host}:{args.port}")
